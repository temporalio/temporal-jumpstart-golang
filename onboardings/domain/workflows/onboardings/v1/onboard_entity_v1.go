...
// OnboardEntity is the initial launch (v1) of this workflow
func OnboardEntity(ctx workflow.Context, args *workflowsv1.OnboardEntityRequest) error {
...
func setQueryHandlers(ctx workflow.Context, args *workflowsv1.OnboardEntityRequest, state *queriesv1.EntityOnboardingStateResponse, calculator onboardings.OnboardEntityDurationCalculator) error {
	if err := workflow.SetQueryHandlerWithOptions(ctx, onboardings.QueryEntityOnboardingState, func() (*queriesv1.EntityOnboardingStateResponse, error) {
